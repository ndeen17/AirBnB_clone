#!/usr/bin/python3
"""this Module for test classes"""
import inspect
import pep8


class TestClassDocumentation():
    """this is the Class that allow us to test multiples classes"""
    ...
    def documentation(self):
        """this is the Test documentation of the module, class and methods"""
    ...
    def pep8(self, files):
        """this is the Test linter pep8 over the files"""
